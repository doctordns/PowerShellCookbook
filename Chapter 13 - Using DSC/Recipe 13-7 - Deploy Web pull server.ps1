...
# O. Obtain xPSDesiredStateConfiguration
Install-Module xPSDesiredStateConfiguration


# 1. Create Self-Signed Certificate for SRV1 and copy to SRV2
$DscCert = New-SelfSignedCertificate -CertStoreLocation 'CERT:\LocalMachine\MY' `
                                     -DnsName 'SRV1' 
...
Node SRV1 {
    ...
    File RegistrationKeyFile {
       Ensure                = 'Present'
       Type                  = 'File'
       DestinationPath       = 'C:\ProgramFiles\WindowsPowerShell\DscService\RegistrationKeys.txt'
